 ...
 * @summary Unit tests for PDF pagination calculation functions
 */
...
describe('calculateNextPage', () => {
  ...
  it('should handle first page of multi-page document', () => {
  ...
  it('should handle middle page', () => {
    const result = calculateNextPage({ currentPage: 3, totalPages: 5 });
...
describe('canGoToNextPage', () => {
  it('should return true when not at last page', () => {
    ...
    expect(canGoToNextPage(3, 5)).toBe(true);
...
describe('canGoToPreviousPage', () => {
  ...
  it('should handle edge case with page 0', () => {
