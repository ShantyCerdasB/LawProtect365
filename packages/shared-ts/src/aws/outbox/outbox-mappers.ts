...
import type { OutboxDdbItem } from './outbox-ddb-types.js';
import { OutboxKeyBuilders, OUTBOX_STATUSES, DynamoDbPrefixes } from './outbox-ddb-types.js';
 ...
 */
export const outboxDdbMapper = {
  toDdbItem: outboxToDdbItem,
  fromDdbItem: outboxFromDdbItem,
  isDdbItem: isOutboxDdbItem
};
