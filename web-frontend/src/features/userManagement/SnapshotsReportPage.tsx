...
import snapshotIcon                      from '@assets/manage_icon_sidebar.png';
import {
  getSnapshots,
  deleteSnapshot,
  SnapshotReport as SnapshotDTO        // ← import the service’s interface
} from '../../services/snapshotsClient';
