...
foreach ($file in $files) {
    ...
    # Fix relative imports for common value objects
    $content = $content -replace 'from "../../../domain/value-objects/Email"', 'from "@/domain/value-objects/common"'
    $content = $content -replace 'from "../../../domain/value-objects/PersonName"', 'from "@/domain/value-objects/common"'
    $content = $content -replace 'from "../../../domain/value-objects/Reason"', 'from "@/domain/value-objects/common"'
    $content = $content -replace 'from "../../../domain/value-objects/FileSize"', 'from "@/domain/value-objects/common"'
    ...
    # Fix relative imports for document value objects
    $content = $content -replace 'from "../../../domain/value-objects/ContentType"', 'from "@/domain/value-objects/document"'
    $content = $content -replace 'from "../../../domain/value-objects/DocumentStatus"', 'from "@/domain/value-objects/document"'
    $content = $content -replace 'from "../../../domain/value-objects/Geometry"', 'from "@/domain/value-objects/document"'
    $content = $content -replace 'from "../../../domain/value-objects/HashDigest"', 'from "@/domain/value-objects/document"'
    ...
    # Fix relative imports for other value objects
    $content = $content -replace 'from "../../../domain/value-objects/EnvelopeStatus"', 'from "@/domain/value-objects/envelope"'
    $content = $content -replace 'from "../../../domain/value-objects/S3ObjectRef"', 'from "@/domain/value-objects/storage"'
    $content = $content -replace 'from "../../../domain/value-objects/Kms"', 'from "@/domain/value-objects/security"'
    $content = $content -replace 'from "../../../domain/value-objects/RequestToken"', 'from "@/domain/value-objects/security"'
    ...
    $content = $content -replace 'from "../value-objects/Email"', 'from "@/domain/value-objects/common"'
    $content = $content -replace 'from "../value-objects/PersonName"', 'from "@/domain/value-objects/common"'
    $content = $content -replace 'from "../value-objects/Reason"', 'from "@/domain/value-objects/common"'
    $content = $content -replace 'from "../value-objects/FileSize"', 'from "@/domain/value-objects/common"'
    $content = $content -replace 'from "../value-objects/Page"', 'from "@/domain/value-objects/common"'
    $content = $content -replace 'from "../value-objects/PaginationCursor"', 'from "@/domain/value-objects/common"'
    $content = $content -replace 'from "../value-objects/ObjectVersion"', 'from "@/domain/value-objects/common"'
    
    $content = $content -replace 'from "../value-objects/ContentType"', 'from "@/domain/value-objects/document"'
    $content = $content -replace 'from "../value-objects/DocumentStatus"', 'from "@/domain/value-objects/document"'
    $content = $content -replace 'from "../value-objects/Geometry"', 'from "@/domain/value-objects/document"'
    $content = $content -replace 'from "../value-objects/HashDigest"', 'from "@/domain/value-objects/document"'
    $content = $content -replace 'from "../value-objects/InputType"', 'from "@/domain/value-objects/document"'
    
    $content = $content -replace 'from "../value-objects/EnvelopeStatus"', 'from "@/domain/value-objects/envelope"'
    $content = $content -replace 'from "../value-objects/S3ObjectRef"', 'from "@/domain/value-objects/storage"'
    $content = $content -replace 'from "../value-objects/Kms"', 'from "@/domain/value-objects/security"'
    $content = $content -replace 'from "../value-objects/RequestToken"', 'from "@/domain/value-objects/security"'
    $content = $content -replace 'from "../value-objects/Audit"', 'from "@/domain/value-objects/audit"'
    $content = $content -replace 'from "../value-objects/ConsentRecord"', 'from "@/domain/value-objects/consent"'
    
    # Fix domain-level imports
    $content = $content -replace 'from "../../domain/value-objects/Email"', 'from "@/domain/value-objects/common"'
    $content = $content -replace 'from "../../domain/value-objects/PersonName"', 'from "@/domain/value-objects/common"'
    $content = $content -replace 'from "../../domain/value-objects/Reason"', 'from "@/domain/value-objects/common"'
    $content = $content -replace 'from "../../domain/value-objects/FileSize"', 'from "@/domain/value-objects/common"'
