 ...
 * @example
 * const { prisma, user } = createPrismaMock({ user: createPrismaModelMock() });
 */
...
/**
 * Convenience function for creating User-specific Prisma mocks
 * @returns Object with prisma client and user model mock
 */
export function createUserPrismaMock() {
  const user = createPrismaModelMock();
  return createPrismaMock({ user });
}

/**
 * Convenience function for creating OAuthAccount-specific Prisma mocks
 * @returns Object with prisma client and oAuthAccount model mock
 */
export function createOAuthAccountPrismaMock() {
  const oAuthAccount = createPrismaModelMock();
  return createPrismaMock({ oAuthAccount });
}

/**
 * Convenience function for creating UserAuditEvent-specific Prisma mocks
 * @returns Object with prisma client and userAuditEvent model mock
 */
export function createUserAuditEventPrismaMock() {
  const userAuditEvent = createPrismaModelMock();
  return createPrismaMock({ userAuditEvent });
}

/**
 * Convenience function for creating UserPersonalInfo-specific Prisma mocks
 * @returns Object with prisma client and userPersonalInfo model mock
 */
export function createUserPersonalInfoPrismaMock() {
  const userPersonalInfo = createPrismaModelMock();
  return createPrismaMock({ userPersonalInfo });
}
