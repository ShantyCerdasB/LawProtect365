...
function setupSuccessfulMocks(
  mockEnvelopeAccessService: any,
  mockEnvelopeSignerService: any,
  mockEnvelopeStateService: any,
  mockEnvelopeNotificationService: any,
  mockSignatureEnvelopeService: any,
  testEnvelope: any,
  updatedEnvelope: any
) {
