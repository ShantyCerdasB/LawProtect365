...
export const SignatureErrorCodes = {
  ...
  ENVELOPE_UPDATE_FAILED: "ENVELOPE_UPDATE_FAILED",
  ENVELOPE_DELETE_FAILED: "ENVELOPE_DELETE_FAILED",
  ENVELOPE_ACCESS_DENIED: "ENVELOPE_ACCESS_DENIED",
  ENVELOPE_TEMPLATE_VALIDATION_FAILED: "ENVELOPE_TEMPLATE_VALIDATION_FAILED",
  ENVELOPE_REQUEST_VALIDATION_FAILED: "ENVELOPE_REQUEST_VALIDATION_FAILED",
  ...
  SIGNER_CREATION_FAILED: "SIGNER_CREATION_FAILED",
  SIGNER_UPDATE_FAILED: "SIGNER_UPDATE_FAILED",
  SIGNER_DELETE_FAILED: "SIGNER_DELETE_FAILED",
  SIGNER_ACCESS_DENIED: "SIGNER_ACCESS_DENIED",
  SIGNER_SIGNING_ORDER_VIOLATION: "SIGNER_SIGNING_ORDER_VIOLATION",
  ...
  // Reminder Tracking
  REMINDER_TRACKING_NOT_FOUND: "REMINDER_TRACKING_NOT_FOUND",
  REMINDER_TRACKING_FAILED: "REMINDER_TRACKING_FAILED",
  ...
  // Age Validation
  AGE_VALIDATION_REQUIRED: "AGE_VALIDATION_REQUIRED",
  ...
  INVITATION_TOKEN_REVOKED: "INVITATION_TOKEN_REVOKED",
  ...
  DOCUMENT_SERVICE_ERROR: "DOCUMENT_SERVICE_ERROR",
  ...
  PDF_SIGNATURE_EMBEDDING_FAILED: "PDF_SIGNATURE_EMBEDDING_FAILED",
  PDF_BYTE_RANGE_INVALID: "PDF_BYTE_RANGE_INVALID"
} as const;
