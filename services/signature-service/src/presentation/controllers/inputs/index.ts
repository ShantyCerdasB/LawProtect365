/**
 * @file index.ts
 * @summary Barrel export for Inputs controllers
 * @description Exports all Inputs controller classes
 */

// ✅ CONTROLLERS REFACTORIZADOS - PATRÓN FACTORY
...
export { UpdateInputController } from "./UpdateInput.Controller";
