...
import { DEFAULT_ENTITY_INDEX } from "../../shared/types/infrastructure/constants";
import { mapCreateInputToDto, mapDtoToRecord } from "./mappers/OutboxItemDTO.mapper";
import type { OutboxRepositoryDdbProps, OutboxRepoCreateInput } from "../../shared/types/outbox";
...
export class OutboxRepositoryDdb implements OutboxPort {
  ...
  async save(evt: DomainEvent, traceId?: string): Promise<void> {
    const input: OutboxRepoCreateInput = {
      id: evt.id,
      eventType: evt.type,
