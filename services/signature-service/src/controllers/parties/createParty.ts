/**
 * @file createParty.ts
 * @description Controller for creating new Parties via POST /envelopes/{envelopeId}/parties endpoint.
...
/**
 * @description Base handler function for creating a new Party.
...
const base: HandlerFn = async (evt) => {
  const { params, body } = validateRequest(evt, { 
