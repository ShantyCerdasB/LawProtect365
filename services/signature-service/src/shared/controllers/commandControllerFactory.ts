/**
 * @file commandControllerFactory.ts
 * @summary Command controller factory using shared-ts middleware system
 * @description Factory for creating standardized command controllers (POST/PUT/PATCH/DELETE operations)
 */
 ...
 * @description Factory function that creates a standardized command controller
 * 
 * @param config - Configuration for the controller
 * @returns HandlerFn for the command operation
 */
export const createCommandController = <TInput, TOutput>(
