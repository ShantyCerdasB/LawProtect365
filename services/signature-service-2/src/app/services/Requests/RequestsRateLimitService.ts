...
export class RequestsRateLimitService implements IRequestsRateLimitService {
   ...
   */
  async checkInviteLimit(envelopeId: EnvelopeId, _actor: ActorContext): Promise<void> {
   ...
   */
  async checkRemindLimit(envelopeId: EnvelopeId, partyId: PartyId, _actor: ActorContext): Promise<void> {
   ...
   */
  async checkRequestSignatureLimit(envelopeId: EnvelopeId, partyId: PartyId, _actor: ActorContext): Promise<void> {
   ...
   */
  async checkAddViewerLimit(envelopeId: EnvelopeId, _actor: ActorContext): Promise<void> {
   ...
   */
  async checkCancelLimit(envelopeId: EnvelopeId, _actor: ActorContext): Promise<void> {
   ...
   */
  async checkDeclineLimit(envelopeId: EnvelopeId, _actor: ActorContext): Promise<void> {
   ...
   */
  async checkFinaliseLimit(envelopeId: EnvelopeId, _actor: ActorContext): Promise<void> {
